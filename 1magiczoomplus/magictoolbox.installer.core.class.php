<?php
    ...
    class MagicToolboxCoreInstallerClass {
        ...
        function sendStat($mode = '') {
            ...
            if('working' == 'v3.2.13' || 'working' == 'v4.5.41') {
                return;
            }
            ...
            $path = "api/stat/?action={$mode}&tool_name=magiczoomplus&license=trial&tool_version=v4.5.41&module_version=v3.2.13&platform_name=opencart&platform_version={$platformVersion}&url={$url}";

	...
	public function index() {
		...
		if ($category_info) {
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/product/category.tpl')) {
				  $this->response->setOutput(magiczoomplus($this->load->view($this->config->get('config_template') . '/template/product/category.tpl', $data),$this,'category',(isset($results) ? $results : array() )));	
			} else {

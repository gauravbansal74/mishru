...
<!--             <li><?php echo $text_model; ?> <?php echo $model; ?></li> -->
          ...
          <div id="product">
            ...
            <button type="button" class="btn btn-primary btn-lg btn-block" title="<?php echo $button_wishlist; ?>" onclick="wishlist.add('<?php echo $product_id; ?>');"><?php echo $button_wishlist; ?></button>
            </div>
            <?php if ($minimum > 1) { ?>

            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
					...
					<td class="text-left required"><?php echo $entry_primary_product; ?></td>
              ...
              <tbody> 
                <tr>
				  ...
				  <td class="text-left" style="vertical-align: top;">
					<div class="form-group required <?php if ($error_primary_product) {echo 'has-error';}?>">
					  <input type="text" name="primary_product" value="<?php echo $combo['primary_product']; ?>" id="primary_product" class="form-control" />
					  </div>
					  <?php if ($error_primary_product) { ?>
						<div class="text-danger"><?php echo $error_primary_product; ?></div>
					  <?php } ?>
					</div>  
				  </td>
				  <td class="text-left" style="vertical-align: top;">
				...
				<tr>
                  <td class="text-center" colspan="5"><strong><?php echo $text_next_version; ?></strong></td>
                </tr>
              </tbody>
            </table>
			<div>
...
$(document).ready(function(){	
	...
	$('input[name=\'primary_product\']').autocomplete({
		delay: 500,
		'source': function(request, response) {
			$.ajax({
				url: 'index.php?route=catalog/product/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request),
		...
		'select': function(item) {
			...
			$('input[name=\'primary_product\']').val('');
			$('input[name=\'primary_product\']').val(value);

            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
					...
					<td class="text-left"><?php echo $entry_primary_product; ?></td>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-left"><?php echo $combo['primary_product']; ?></td>
				  <td class="text-left">
                  ...
                  <td class="text-center"><a href="<?php echo $combo['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                </tr>
                <?php } ?>
				<tr>

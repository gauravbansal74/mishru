      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <li><a href="#tab-customize" data-toggle="tab">Customize</a></li>
          </ul>
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-customize">
                ...
                <div class="form-group">
                      <label class="col-sm-2 control-label" for="input-customizable<?php echo $language['language_id']; ?>"><?php echo $entry_customize; ?></label>
                      <div class="col-sm-10">
                        <input type="text" name="product_description[<?php echo $language['language_id']; ?>][customizable]" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['customizable'] : ''; ?>" placeholder="<?php echo $entry_customize; ?>" id="input-customizable<?php echo $language['language_id']; ?>" class="form-control" />
                        <?php if (isset($error_name[$language['language_id']])) { ?>
                        <div class="text-danger"><?php echo $error_name[$language['language_id']]; ?></div>
                        <?php } ?>
                      </div>
                ...
                <div class="form-group">
                      <label class="col-sm-2 control-label" for="input-region1<?php echo $language['language_id']; ?>"><?php echo $entry_region1; ?></label>
                      <div class="col-sm-10">
                        <input type="text" name="product_description[<?php echo $language['language_id']; ?>][region1]" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['region1'] : ''; ?>" placeholder="<?php echo $entry_region1; ?>" id="input-region1<?php echo $language['language_id']; ?>" class="form-control" />
                        <?php if (isset($error_name[$language['language_id']])) { ?>
                        <div class="text-danger"><?php echo $error_name[$language['language_id']]; ?></div>
                        <?php } ?>
                      </div>
                ...
                <div class="form-group">
                      <label class="col-sm-2 control-label" for="input-region3<?php echo $language['language_id']; ?>"><?php echo $entry_region3; ?></label>
                      <div class="col-sm-10">
                        <input type="text" name="product_description[<?php echo $language['language_id']; ?>][region3]" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['region3'] : ''; ?>" placeholder="<?php echo $entry_region3; ?>" id="input-region3<?php echo $language['language_id']; ?>" class="form-control" />
                        <?php if (isset($error_name[$language['language_id']])) { ?>
                        <div class="text-danger"><?php echo $error_name[$language['language_id']]; ?></div>
                        <?php } ?>
                      </div>
                ...
                <div class="form-group">
                      <label class="col-sm-2 control-label" for="input-region5<?php echo $language['language_id']; ?>"><?php echo $entry_region5; ?></label>
                      <div class="col-sm-10">
                        <input type="text" name="product_description[<?php echo $language['language_id']; ?>][region5]" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['region5'] : ''; ?>" placeholder="<?php echo $entry_region5; ?>" id="input-region5<?php echo $language['language_id']; ?>" class="form-control" />
                        <?php if (isset($error_name[$language['language_id']])) { ?>
                        <div class="text-danger"><?php echo $error_name[$language['language_id']]; ?></div>
                        <?php } ?>
                      </div>
                ...
                <div class="form-group">
                      <label class="col-sm-2 control-label" for="input-region6-name<?php echo $language['language_id']; ?>"><?php echo $entry_region6_name; ?></label>
                      <div class="col-sm-10">
                        <input type="text" name="product_description[<?php echo $language['language_id']; ?>][region6_name]" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['region6_name'] : ''; ?>" placeholder="<?php echo $entry_region6_name; ?>" id="input-region6-name<?php echo $language['language_id']; ?>" class="form-control" />
                        <?php if (isset($error_name[$language['language_id']])) { ?>
                        <div class="text-danger"><?php echo $error_name[$language['language_id']]; ?></div>
                        <?php } ?>
                      </div>
                ...
                <div class="form-group">
                      <label class="col-sm-2 control-label" for="input-region7-name<?php echo $language['language_id']; ?>"><?php echo $entry_region7_name; ?></label>
                      <div class="col-sm-10">
                        <input type="text" name="product_description[<?php echo $language['language_id']; ?>][region7_name]" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['region7_name'] : ''; ?>" placeholder="<?php echo $entry_region7_name; ?>" id="input-region7-name<?php echo $language['language_id']; ?>" class="form-control" />
                        <?php if (isset($error_name[$language['language_id']])) { ?>
                        <div class="text-danger"><?php echo $error_name[$language['language_id']]; ?></div>
                        <?php } ?>
                      </div>

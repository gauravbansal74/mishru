...
class ControllerProductProduct extends Controller {
	...
	public function index() {
		...
		if ($product_info) {
			...
			$data['region'] = $product_info['region'];
			$data['region1'] = $product_info['region1'];
			$data['region2'] = $product_info['region2'];
			...
			$data['entry_customizable'] = $this->language->get('entry_customizable');
			$data['entry_region'] = $this->language->get('entry_region');
			$data['entry_region1'] = $this->language->get('entry_region1');
			$data['entry_region2'] = $this->language->get('entry_region2');
...
$product_info['images'] = $results;
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/product/product.tpl')) {
				$this->response->setOutput(magiczoomplus($this->load->view($this->config->get('config_template') . '/template/product/product.tpl', $data),$this,'product',$product_info));	
			} else {
